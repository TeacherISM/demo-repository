...
resource "null_resource" "docker_packaging" {
  ...
  provisioner "local-exec" {
    ...
    docker tag demo-repository-ecr:latest public.ecr.aws/t5t9a6c4/demo-repository-ecr:latest
    docker push public.ecr.aws/t5t9a6c4/demo-repository-ecr:latest
    EOF
  }
